...
GITHUB_REPO   = 'khalequzzaman17/dotserve'
CURRENT_VERSION = 'v1.0.0'
VERSION_FILE  = '/opt/dotserve/version.txt'
INSTALL_DIR   = '/opt/dotserve'
REPO_DIR      = '/root/dotserve'
...
def check_update():
    ...
    try:
        ...
        raw_req.add_header('User-Agent', 'DotServe/3.0')
    ...
    try:
        ...
        req2.add_header('User-Agent', 'DotServe/3.0')
        ...
        if tag_names:
            ...
            try:
                ...
                rel_req.add_header('User-Agent', 'DotServe/3.0')
...
def start_update():
    ...
    target = d.get('version', '')  # tag name like v1.0.0
    ...
    def run_update():
        ...
        try:
            ...
            # 6. Restart service
            log('🔄 Restarting DotServe service...')
            _, _, rc = sh('systemctl restart dotserve 2>&1')
            if rc == 0:
                log('✓ DotServe service restarted successfully')
            else:
            ...
            log('')
            log('✅ DotServe updated successfully!')
